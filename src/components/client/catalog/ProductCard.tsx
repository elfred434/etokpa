...
export default function ProductCard({ product, onAdd, onOpen }: ProductCardProps) {
  const out = product.stock === 'out';

  return (
    <article
      className="card relative flex cursor-pointer flex-col gap-sm p-md transition-shadow hover:shadow-md"
