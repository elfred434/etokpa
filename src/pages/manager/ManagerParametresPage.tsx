    ...
    <ManagerLayout currentPath="/manager/parametres">
      <div className="space-y-6">
        <div className="rounded-lg border border-error bg-error-container p-4 text-label text-on-error-container">
          ...
          <p>
            Pas de endpoints paramètres de zone côté backend (<span className="font-mono">/manager/settings</span>).
            Aperçu <strong>maquette</strong> — « Enregistrer » n’écrit nulle part.
          </p>
        </div>
        ...
        <div className="opacity-70">
          ...
          {onglet === ONGLETS[1] && (
            <section className="rounded-lg border border-border-default bg-white p-lg shadow-sm">
              ...
              <div className="mt-4">
                ...
                <Ligne label="Délai d’acceptation par livreur">
          ...
          {onglet === ONGLETS[2] && (
            <section className="rounded-lg border border-border-default bg-white p-lg shadow-sm">
              <h2 className="text-h3 font-h3 font-bold">Alertes Manager & Seuils</h2>
              <div className="mt-4">
        ...
        <div className="flex items-center justify-end gap-3">
          {enregistre && (
            <p className="text-label font-semibold text-error">Enregistrement impossible — endpoint absent (B-16).</p>
          )}
